...
// amr.getAccountMap().put(1, acc1);
// amr.updateAccount(1,
// "{\"id\":1,\"accountNumber\":\"D0001\",\"firstName\":\"Matt\",\"lastName\":\"Wright\"}");
...
// assertEquals(amr.createAccount(jsonUtil.getJSONForObject(acc1)), "Account
// successfuly created");
// assertEquals(amr.createAccount(jsonUtil.getJSONForObject(acc2)), "Account
// successfuly created");
...
// String stringToTest =
// "{\"id\":1,\"accountNumber\":\"D0001\",\"firstName\":\"Matt\",\"lastName\":\"Hunt\"}";
